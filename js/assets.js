...
(function () {
  ...
  const I = {
    ...
    utensils: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 3v18"/><path d="M4 3v4M10 3v4"/><path d="M4 7c0 1.4 1.3 2.5 3 2.5s3-1.1 3-2.5"/><path d="M17 3v18"/><path d="M17 3c-3 0-5 2.8-5 6.3 0 2.4 2 3.4 5 3.4"/></svg>',
