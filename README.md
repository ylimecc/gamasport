...
| Página | Función |
|---|---|
| `index.html` | Home: servicios, reserva y contacto |
| `catalogo.html` / `producto.html` | Catálogo de productos y detalle |
| `carrito.html` / `checkout.html` / `confirmacion.html` | Flujo de compra completo |
| `contacto.html` | Formulario de contacto |
| `privacidad.html` / `terminos.html` | Legales |

## Tecnología

HTML + CSS + JavaScript puro, sin frameworks ni build. Hospedado en GitHub Pages.
